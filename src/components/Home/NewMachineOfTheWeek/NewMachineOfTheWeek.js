...
import './NewMachineOfTheWeek.css';
import topImageBanner from './topImageBanner.jpg';
import {Link} from 'react-router-dom';


function NewMachineOfTheWeek() {
  return (
    <div className=" " >
    	
    	<div className='mh3 ph3  machine-of-week-main-mobile-view'>
    		<section class=" " >
			  <h2 class=" f2 fw1 ph3 ph0-l pt5 pb2 mobile-display-font-size-header ">Cat 990K Large Wheel Loader</h2>
			  <article class="bt bb b--black-10 ">
			    <p class="db pv4 ph3 ph0-l no-underline black machine-of-week-image-and-paragraph-width-mobile-view ">
			      <div class="flex flex-column flex-row-ns machine-of-week-mobile-view ">
			        ...
			        <div class="w-100 w-40-ns pl3-ns machine-of-week-paragraph-width-mobile-view">
			          <h1 class="f3 fw1  mt0 lh-title">CAT 990K Large Wheel Loader, 80974 kg, 10 cum, 752 hp</h1>
			          <p class="f6 f5-l lh-copy bt pt4 b--black-10">
			             <div class="dt w-100 mt1">
						     ...
						     <div class="dt w-100 mt1">
						      ...
						      <div class="dtc tr">
						        <h2 class="f5 mv0 fw1">CAT 990K</h2>
						      </div>
						    </div>
						     ...
						     <div class="dt w-100 mt1">
						      <div class="dtc">
						        <h1 class="f5 f4-ns mv0 fw1">Tipping Load:</h1>
						      </div>
						      <div class="dtc tr">
						        <h2 class="f5 mv0 fw1">49513 kg</h2>
						      </div>
						    </div>
						     ...
						     <div class="dt w-100 mt1">
						      ...
						      <div class="dtc tr">
						        <h2 class="f5 mv0 fw1 ">$120,000</h2>
						      </div>
						    </div>
			          ...
			          <h1 class="f3 fw1 pt3 pb0  lh-title">Features</h1>
			          <p class="f6 f5-l lh-copy ">
			          	Maximised Durability With Delayed Engine Shutdown.<br/>
						Advanced Engine Controls Maximize Power.<br/>
						Torque Converter With Lock-up Clutch.<br/>
						Electro Hydraulic Controls Increases Productivity.<br/>
...
export default NewMachineOfTheWeek;
